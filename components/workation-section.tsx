              ...
              {!isExpanded && (
                <div className="flex items-center space-x-4 mt-3 text-sm">
                  ...
                  <span className="flex items-center space-x-1">
                    ...
                    <span>4 workspace</span>
                  </span>
                  <span className="flex items-center space-x-1">
                    <Calendar className="w-4 h-4 text-green-600" />
                    <span>Giảm 20% ở dài hạn</span>
                  </span>
                </div>
              )}
            </div>
        ...
        <div className="space-y-6 animate-in slide-in-from-top-4 duration-300">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Card className="p-4 text-center hover:shadow-md transition-shadow">
              ...
              <p className="font-semibold mb-1">300 Mbps</p>
            ...
            <Card className="p-4 text-center hover:shadow-md transition-shadow">
              ...
              <p className="font-semibold mb-1">4 khu vực</p>
            ...
            <Card className="p-4 text-center hover:shadow-md transition-shadow">
              ...
              <p className="font-semibold mb-1">3 không gian</p>
              <p className="text-xs text-muted-foreground">Co-working gần đây</p>
            </Card>
            ...
            <Card className="p-4 text-center hover:shadow-md transition-shadow">
              ...
              <p className="font-semibold mb-1">Giảm 20%</p>
              <p className="text-xs text-muted-foreground">Ở từ 1 tháng</p>
            </Card>
          </div>
          ...
          <Tabs defaultValue="wifi" className="w-full">
            ...
            <TabsContent value="wifi" className="mt-6">
              <WiFiSpeedTest
                downloadSpeed={wifiSpeed?.download}
                uploadSpeed={wifiSpeed?.upload}
                ping={wifiSpeed?.ping}
                lastTested={wifiSpeed?.lastTested}
              />
            </TabsContent>

            <TabsContent value="workspace" className="mt-6">
              <WorkspaceShowcase listingId={listingId} />
            </TabsContent>
          ...
          <Card className="p-6 bg-gradient-to-r from-purple-50 via-blue-50 to-indigo-50 dark:from-purple-900/10 dark:via-blue-900/10 dark:to-indigo-900/10 border-purple-200 dark:border-purple-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  <span className="font-medium text-foreground">✓ Thiết bị đầy đủ:</span> Màn hình, ghế công thái học, đèn bàn
                </p>
              </div>
              <div className="space-y-2">
                <p className="text-muted-foreground">
                  <span className="font-medium text-foreground">✓ Cộng đồng gần đây:</span> Dễ dàng networking với digital nomads khác
                </p>
                <p className="text-muted-foreground">
