				...
				<div className="grid gap-12 rounded-3xl border border-slate-100 bg-white/90 p-10 shadow-[0_40px_120px_-80px_rgba(15,23,42,0.9)] backdrop-blur lg:grid-cols-[1fr_1.2fr] lg:items-center">
					<div className="space-y-5">
						...
						<p className="text-lg text-slate-600">
							Thu phóng, khoanh vùng và lưu khu vực yêu thích. LuxeStay cập nhật giá real-time, hiển thị tiện nghi quan
							trọng, quán ăn, địa điểm vui chơi chỉ trong một lần chạm.
						</p>
						...
						<Button className="rounded-xl bg-primary px-7 py-6 text-base font-semibold text-primary-foreground shadow-lg shadow-primary/20 hover:bg-primary/90">
							Mở bản đồ tương tác
						</Button>
					</div>
