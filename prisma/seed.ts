...
async function main() {
    ...
    membershipPlanConfigs.map((plan) =>
      prisma.membershipPlan.upsert({
        ...
        update: {
          ...
          experienceDiscountRate: plan.experienceDiscountRate,
  ...
  console.log('💎 Seeding secret member listings...')
  const secretListings = [
    {
      slug: 'skyline-loft-saigon',
      hostId: host2.id,
      title: 'Skyline Loft Saigon',
      description:
        'Penthouse hai tầng ngắm toàn cảnh Sài Gòn với hồ bơi sky lounge riêng và dịch vụ quản gia 24/7 dành cho hội viên Diamond.',
      propertyType: 'APARTMENT',
      roomType: 'ENTIRE_PLACE',
      maxGuests: 6,
      bedrooms: 3,
      ...
      latitude: 10.7769,
      longitude: 106.7009,
      neighborhood: 'Phố đi bộ Nguyễn Huệ',
      nearbyPlaces: buildNearbyPlaces('TP. Hồ Chí Minh', 10.7769, 106.7009),
      basePrice: 6500000,
      cleaningFee: 700000,
      serviceFee: 500000,
      weeklyDiscount: 8,
      ...
      currency: 'VND',
      images: [
        'https://images.unsplash.com/photo-1529429617124-aee711fa4668?w=1200',
        'https://images.unsplash.com/photo-1521783593447-5702af2af2ab?w=1200',
        'https://images.unsplash.com/photo-1549187774-b4e9b0445b07?w=1200',
        'https://images.unsplash.com/photo-1484154218962-a197022b5858?w=1200',
      ],
      amenities: [],
      checkInTime: '15:00',
      ...
      allowChildren: true,
      hasSmartLock: true,
      wifiName: 'SkylineDiamond',
      wifiPassword: 'diamond2024',
      isVerified: true,
      status: 'ACTIVE',
      featured: true,
      isSecret: true,
    ...
    {
      slug: 'azure-tide-beachfront-villa',
      hostId: host2.id,
      title: 'Azure Tide Beachfront Villa',
      description:
        'Villa biệt lập sát biển với hồ bơi muối khoáng và bến du thuyền riêng, bao gồm private chef và butler dành cho hội viên LuxeStay.',
      propertyType: 'VILLA',
      roomType: 'ENTIRE_PLACE',
      maxGuests: 12,
      bedrooms: 5,
      ...
      city: 'Phú Quốc',
      state: 'Kiên Giang',
      address: 'Bãi Kem, An Thới',
      zipCode: '920000',
      latitude: 9.9855,
      longitude: 104.0414,
      neighborhood: 'Sunset Town',
      nearbyPlaces: buildNearbyPlaces('Phú Quốc', 9.9855, 104.0414),
      basePrice: 8900000,
      cleaningFee: 900000,
      serviceFee: 650000,
      weeklyDiscount: 12,
      ...
      totalBookings: 11,
      occupancyRate: 68,
      publishedAt: new Date('2024-02-12T09:00:00Z'),
    },
    {
      slug: 'da-nang-ocean-penthouse',
      hostId: host1.id,
      title: 'Đà Nẵng Ocean Penthouse',
      description:
        'Penthouse hai tầng hướng biển Mỹ Khê với phòng giải trí riêng, phòng chiếu phim và lounge champagne dành cho hội viên Gold & Diamond.',
      propertyType: 'APARTMENT',
      roomType: 'ENTIRE_PLACE',
      maxGuests: 8,
      bedrooms: 4,
      ...
      city: 'Đà Nẵng',
      state: 'Đà Nẵng',
      address: 'Võ Nguyên Giáp, Sơn Trà',
      zipCode: '550000',
      latitude: 16.0678,
      longitude: 108.2405,
      neighborhood: 'Mỹ Khê',
      nearbyPlaces: buildNearbyPlaces('Đà Nẵng', 16.0678, 108.2405),
      basePrice: 7200000,
      cleaningFee: 650000,
      serviceFee: 520000,
      weeklyDiscount: 10,
      ...
      currency: 'VND',
      images: [
        'https://images.unsplash.com/photo-1529101091764-c3526daf38fe?w=1200',
        'https://images.unsplash.com/photo-1521782462922-9318be1f781b?w=1200',
      ...
      allowChildren: true,
      hasSmartLock: true,
      wifiName: 'DanangPenthouse',
      wifiPassword: 'mykheview',
      isVerified: true,
      status: 'ACTIVE',
      featured: true,
      isSecret: true,
      ...
      totalBookings: 14,
      occupancyRate: 74,
      publishedAt: new Date('2024-03-03T07:30:00Z'),
    },
    {
      slug: 'le-reve-garden-villa-da-lat',
      hostId: host1.id,
      title: 'Le Rêve Garden Villa Đà Lạt',
      description:
        'Biệt thự vườn kiểu Pháp với nhà kính hoa và phòng trà chiều riêng, gồm quản gia và xe đưa đón sân bay dành cho hội viên.',
      propertyType: 'VILLA',
      roomType: 'ENTIRE_PLACE',
      maxGuests: 10,
      bedrooms: 4,
      ...
      city: 'Đà Lạt',
      state: 'Lâm Đồng',
      address: 'Nguyễn Du, Phường 9',
      zipCode: '670000',
      latitude: 11.9543,
      longitude: 108.4553,
      neighborhood: 'Đồi Cù',
      nearbyPlaces: buildNearbyPlaces('Đà Lạt', 11.9543, 108.4553),
      basePrice: 5800000,
      cleaningFee: 550000,
      serviceFee: 420000,
      weeklyDiscount: 9,
      ...
      images: [
        'https://images.unsplash.com/photo-1505691723518-36a5ac3be353?w=1200',
        'https://images.unsplash.com/photo-1540126034813-121bf29033d2?w=1200',
      ...
      allowChildren: true,
      hasSmartLock: true,
      wifiName: 'LeReveGarden',
      wifiPassword: 'luxeprivate',
      isVerified: true,
      status: 'ACTIVE',
      featured: true,
      isSecret: true,
      ...
      totalBookings: 12,
      occupancyRate: 66,
      publishedAt: new Date('2024-01-22T10:15:00Z'),
    },
  ] as const

  for (const listing of secretListings) {
    const { slug, publishedAt, ...rest } = listing
  ...
  console.log(`✅ Secret listings prepared (${secretListings.length})`)
  ...
  const curatedCollectionsConfig = [
    ...
    {
      slug: 'secret-diamond',
      title: 'Secret Diamond Collection',
      subtitle: 'Bộ sưu tập bí mật dành cho hội viên LuxeStay',
      description:
        'Những căn penthouse và villa hiếm được concierge LuxeStay kiểm duyệt, bao gồm Skyline Loft Saigon, Azure Tide và Le Rêve Garden Villa.',
      tags: ['Members Only', 'Concierge', 'Private'],
      location: 'TP.HCM, Phú Quốc, Đà Nẵng, Đà Lạt',
      category: 'secret',
      featured: true,
      curator: {
      ...
      listingSlugs: [
        'skyline-loft-saigon',
        'azure-tide-beachfront-villa',
        'da-nang-ocean-penthouse',
        'le-reve-garden-villa-da-lat',
      ],
    },
  ] as const
  ...
  const membersOnlyExperiences = [
    {
      hostId: guide.id,
      title: 'Private Chef Penthouse Dinner',
      description: 'Dùng bữa tối 5 món cùng private chef trong penthouse skyline, kèm wine pairing và concierge cá nhân hoá dành cho hội viên Diamond.',
      category: 'FOOD_DRINK' as const,
      city: 'TP. Hồ Chí Minh',
      state: 'Hồ Chí Minh',
      location: 'Penthouse Nguyễn Huệ',
      latitude: 10.7762,
      longitude: 106.7012,
      ...
      images: [
        ...
        'https://images.unsplash.com/photo-1527185286392-9639d30973a8?w=800',
      ...
      minGuests: 4,
      maxGuests: 10,
      includedItems: ['Private chef', '5 món fine-dining', 'Wine pairing', 'Quản gia phục vụ'],
      notIncluded: ['Vận chuyển đến địa điểm'],
      requirements: ['Hội viên Diamond', 'Thông báo trước 5 ngày'],
      languages: ['Tiếng Việt', 'English'],
      tags: ['Diamond Exclusive', 'Fine Dining', 'Concierge'],
    ...
    {
      hostId: guide.id,
      title: 'Sunrise Yoga & Detox Retreat',
      description: 'Lớp yoga bình minh trên bãi biển riêng Hội An kèm brunch healthy và workshop chế biến detox juice dành cho hội viên Gold trở lên.',
      ...
      latitude: 15.8891,
      longitude: 108.3425,
      image: 'https://images.unsplash.com/photo-1526401281623-7ae6d01669bd?w=800',
      images: [
        'https://images.unsplash.com/photo-1526401281623-7ae6d01669bd?w=800',
        'https://images.unsplash.com/photo-1487241801906-bb92ba5c52c1?w=800',
      ],
      price: 1200000,
      currency: 'VND',
      duration: '6 giờ',
      ...
      minGuests: 6,
      maxGuests: 12,
      includedItems: ['Huấn luyện viên quốc tế', 'Brunch healthy', 'Workshop detox', 'Ảnh lưu niệm'],
      notIncluded: ['Lưu trú'],
      requirements: ['Hội viên Gold trở lên', 'Đăng ký trước 3 ngày'],
      languages: ['Tiếng Việt', 'English'],
      tags: ['Gold Member', 'Wellness', 'Retreat'],
      status: 'ACTIVE' as const,
      isVerified: true,
      featured: false,
      isMembersOnly: true,
    ...
    {
      hostId: guide.id,
      title: 'Hidden Art Walk Hà Nội',
      description: 'Tour nghệ thuật đương đại sau giờ mở cửa, tham quan studio bí mật và gặp gỡ curator dành riêng cho hội viên.',
      category: 'CULTURE' as const,
      city: 'Hà Nội',
      state: 'Hà Nội',
      location: 'Phố Phan Huy Ích',
      latitude: 21.0288,
      longitude: 105.8522,
      ...
      minGuests: 4,
      maxGuests: 8,
      includedItems: ['Curator dẫn tour', 'Vé gallery private', 'Cocktail networking'],
      notIncluded: ['Di chuyển cá nhân'],
      requirements: ['Hội viên Gold trở lên'],
      languages: ['Tiếng Việt', 'English'],
      tags: ['Members Only', 'Nghệ thuật đương đại', 'Nightlife'],
      status: 'ACTIVE' as const,
      isVerified: true,
      featured: false,
      isMembersOnly: true,
  ...
  for (const experienceData of membersOnlyExperiences) {
    ...
    if (existingExperience) {
      await prismaAny.experience.update({
        where: { id: existingExperience.id },
        data: experienceData,
      })
    } else {
      await prismaAny.experience.create({ data: experienceData })
    }
  }

  console.log('✅ Experiences created (bao gồm members-only)')
